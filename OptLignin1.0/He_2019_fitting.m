...
exportgraphics(fig, fig_path_all+"He2019_"+SP{i}+".png",'Resolution',100)

LC0=lignin_C_remaining(1,i)/obs_data.Ct_obs(1);
par_He2019 = [par_He2019;i, par,LC0,init_CN(i),LC0*init_CN(i),rmse,rsquare];

end

save_fname = excel_path+ "fitted_par_He2019.txt";
save(save_fname,"par_He2019",'-ascii','-double','-tabs')
